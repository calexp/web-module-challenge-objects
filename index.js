...
console.log('Task 1B', createMenuItem('mozarella sticks', 4, 'Appetizer'));
console.log('Task 1B', createMenuItem('Chicken', 12, 'Dinner'));
...
function addReview (name, rating, feedback){
  array = [];
  let object = {name, rating, feedback};
  array.push(object);
  return array;
}
console.log(addReview(reviews, "Daniella", 5, "Beautiful atmosphere and wonderful vegan options!" ));
...
function getLastReview(array) {
  return `${array[array.length -1].name} gave the restaurant a ${array[array.length -1].review} star review, and their feedback was ${array[array.length -1].feedback} `;
} 
